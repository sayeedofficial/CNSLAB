...
string rotateSubKey(string s , int rot)//leftshift function
{
...
{
	ofstream fout ;//optional
	fout.open("keygen.txt");//optional
	for (int i=0; i<16; i++)
	{
...
int main()
{
	...
	//key generation
	cout << "\nSubKeys: " << endl;
	genKeys(key.substr(0,28) , key.substr(28,28),permChoiceTwo,leftShiftTable );
